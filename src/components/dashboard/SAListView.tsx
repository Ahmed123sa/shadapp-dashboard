...
import type { Client, Payment, Manager, TFunc } from '@/components/dashboard/types';
...
export default function SAListView({ t, locale, view, clients, allPayments, managers }: {
  t: TFunc; locale: string; view: string; clients: Client[];
  allPayments: Payment[]; managers: Manager[];
}) {

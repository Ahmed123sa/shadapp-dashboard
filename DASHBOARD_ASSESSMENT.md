...
12. الشرائح المتبقية (Contracts, Chat, Approvals, Meetings, Clients, ...) لسه على النمط القديم — تتنقل شريحة-بشريحة بنفس المنهجية (اختبار توصيفي → hooks → نقل مكوّنات → تحقق) في جلسات لاحقة.
